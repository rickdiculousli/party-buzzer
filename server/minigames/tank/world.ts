...
export const DEFAULT_TANK_CONFIG: Readonly<TankConfig> = {
  ...
  muzzle: 30,
  gun: { damage: 5, clip: 20, intervalMs: 100, reloadMs: 2_000, blastRadius: 8, speed: 450, lifetimeMs: 2_500 },
  cannon: { damage: 30, clip: 1, intervalMs: 0, reloadMs: 4_000, blastRadius: 60, speed: 600, lifetimeMs: 2_500 },
  splash: 20,
  respawnMs: 3_000,
