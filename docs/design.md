...
| `<Glitch text>` | no | shove | A steal, a bust: hits of stutter (`--fx-glitch-dur`, 300ms) then a breather (`--fx-glitch-rest`, ±30%). Cyan/magenta/yellow channels flicker through quadrant windows and a band of the letters tears, with a new cut every hit |
